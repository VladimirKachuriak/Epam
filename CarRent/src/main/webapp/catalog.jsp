...
<c:if test="${currentPage != 1}">
    <td><a href="?${pageContext.request.queryString}&page=${currentPage - 1}"><fmt:message key="label.prev"/></a></td>
</c:if>
    ...
    <tr>
        <c:forEach begin="1" end="${noOfPages}" var="i">
            <c:choose>
                ...
                <c:otherwise>
                    <td><a href="?${pageContext.request.queryString}&page=${i}">${i}</a></td>
                </c:otherwise>
            </c:choose>
        </c:forEach>
    </tr>
...
<c:if test="${currentPage lt noOfPages}">
    <td><a href="?${pageContext.request.queryString}&page=${currentPage + 1}"><fmt:message key="label.next"/></a></td>
</c:if>
